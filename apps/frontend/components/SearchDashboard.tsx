...
export default function SearchDashboard() {
  ...
  //         const data = await apiService.getRecommendations(searchQuery);
  //         results = data.recommendations || [];
  //       } else {
  //         // Guest recommendations (no history)
  //         const data = await apiService.getGuestRecommendations(searchQuery);
  //         results = data.recommendations || [];
  //       }
  //     } else {
  ...
  //       album_image: song.album_image || song.imageUrl || null // Handle both possible field names
  //     }));
  ...
  // Update the handleSearch function in SearchDashboard.tsx to handle inappropriate search messages
